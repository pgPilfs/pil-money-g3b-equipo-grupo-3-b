USE [master]
GO
/****** Object:  Database [Waled_PIL]    Script Date: 9/9/2021 22:33:23 ******/
CREATE DATABASE [Waled_PIL]
 CONTAINMENT = NONE
 ON  PRIMARY 
...
GO
ALTER DATABASE [Waled_PIL] SET COMPATIBILITY_LEVEL = 150
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [Waled_PIL].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [Waled_PIL] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [Waled_PIL] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [Waled_PIL] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [Waled_PIL] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [Waled_PIL] SET ARITHABORT OFF 
GO
ALTER DATABASE [Waled_PIL] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [Waled_PIL] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [Waled_PIL] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [Waled_PIL] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [Waled_PIL] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [Waled_PIL] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [Waled_PIL] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [Waled_PIL] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [Waled_PIL] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [Waled_PIL] SET  DISABLE_BROKER 
GO
ALTER DATABASE [Waled_PIL] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [Waled_PIL] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [Waled_PIL] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [Waled_PIL] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [Waled_PIL] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [Waled_PIL] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [Waled_PIL] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [Waled_PIL] SET RECOVERY FULL 
GO
ALTER DATABASE [Waled_PIL] SET  MULTI_USER 
GO
ALTER DATABASE [Waled_PIL] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [Waled_PIL] SET DB_CHAINING OFF 
GO
ALTER DATABASE [Waled_PIL] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [Waled_PIL] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [Waled_PIL] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [Waled_PIL] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [Waled_PIL] SET QUERY_STORE = OFF
GO
USE [Waled_PIL]
GO
/****** Object:  Table [dbo].[Cuentas]    Script Date: 9/9/2021 22:33:23 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Depositos]    Script Date: 9/9/2021 22:33:23 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Parametros]    Script Date: 9/9/2021 22:33:23 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Retiros]    Script Date: 9/9/2021 22:33:23 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Transacciones]    Script Date: 9/9/2021 22:33:23 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Transferencias]    Script Date: 9/9/2021 22:33:23 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USuarios]    Script Date: 9/9/2021 22:33:23 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
USE [master]
GO
ALTER DATABASE [Waled_PIL] SET  READ_WRITE 
GO
